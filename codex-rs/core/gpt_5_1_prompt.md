...
- Do not waste tokens by re-reading files immediately after editing them. The tool call will fail if it didn't work. The same goes for making folders, deleting folders, etc.
